...
//     return $(select).removeClass('langen').removeClass('langru').removeClass('langsw')
...
//     select.addClass(select.val() == '1' ? 'langen' : 'langru' : 'langsw' );
...
//         cleanSelect(this).addClass($(this).val() == '1' ? 'langen' : 'langru' : 'langsw' );
